...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260628123930_AddAudioInHrQuestion")]
    partial class AddAudioInHrQuestion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AssessmentQuestion", b =>
                {
                    ...
                    b.Property<int?>("TestCasesPasses")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.CodingQuestionTopic", b =>
                {
                    ...
                    b.HasKey("CodingQuestionId", "QuestionTopicId");

                    b.HasIndex("QuestionTopicId");

                    b.ToTable("CodingQuestionTopics");
            ...
            modelBuilder.Entity("Domain.Entities.CvJobAnalysis", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AnalyzeDate = new DateTime(2026, 1, 15, 8, 30, 15, 0, DateTimeKind.Utc),
                            CvId = 1,
                        ...
                        {
                            Id = 2,
                            AnalyzeDate = new DateTime(2026, 2, 15, 8, 30, 15, 0, DateTimeKind.Utc),
                            CvId = 2,
                        ...
                        {
                            Id = 3,
                            AnalyzeDate = new DateTime(2026, 3, 15, 8, 30, 15, 0, DateTimeKind.Utc),
                            CvId = 3,
            ...
            modelBuilder.Entity("Domain.Entities.HrQuestion", b =>
                {
                    ...
                    b.Property<string>("AudioQuestion")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.CodingQuestionTopic", b =>
                {
                    b.HasOne("Domain.Entities.CodingQuestion", "CodingQuestion")
                        .WithMany("CodingQuestionTopics")
                        .HasForeignKey("CodingQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.QuestionTopic", "QuestionTopic")
                        .WithMany("CodingQuestionTopics")
            ...
            modelBuilder.Entity("Domain.Entities.CodingQuestion", b =>
                {
                    b.Navigation("CodingQuestionTopics");
                });
